// Code found on moodle perf test example 1 with some changes to the threshold
...
export let options = {
  ...
  // set a threshold at 250 ms request duration for 95th percentile
  ...
  // i.e. 95% of request durations should be < 250 ms
 	thresholds: {
...
export default function() {
  let res = http.get("https://staging.clipr.solutions/");
