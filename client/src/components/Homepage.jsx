...
function HomePage() {
    ...
    return (
        <div>
            <Container>
                <TypeAnimation className='font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-gray-500'
                    sequence={[
                        'CLIPR Technology',
                        1000,
                    ...
                    wrapper="span"
                    speed={50}
                    style={{ fontSize: '2.5em', display: 'inline-block', marginBottom: '50px' }}
                    repeat={Infinity}
                />
